...
const TrendGraph = () => {
    ...
    return ( 
        <div className='h-[90%] p-1 flex justify-center align-middle1'>
            <div className="max-w-full w-full h-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
            <div className="flex justify-between mb-5">
                ...
                <div id="line-chart" className='h-full w-full'></div>
            </div>
        </div>
    );
}
